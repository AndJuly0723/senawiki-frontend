...
function GuidesArena() {
  ...
  useEffect(() => {
    ...
    setIsLoading(true)
    setLoadError('')
    fetchGuideDecks({ category: 'ARENA', type: 'ARENA' })
      .then((data) => {
        if (!active) return
    ...
    <section className="arena-page">
      <div className="community-toolbar">
        <div className="community-title">
          <h1>결투장</h1>
          <p className="community-title-note">결투장 공략덱 추가는 회원만 가능합니다. 덱 장비는 각 영웅을 클릭하여 확인하세요.</p>
        </div>
        <div className="community-actions">
          ...
          <Link className="community-icon-button" to="/guides/arena/write" aria-label="글쓰기">
