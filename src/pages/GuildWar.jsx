...
function GuildWar() {
  ...
  return (
    <section className="guild-war-page">
      <div className="community-toolbar">
        <div className="community-title">
          <h1>길드전</h1>
          <p className="community-title-note">길드전 공략덱 추가는 회원만 가능합니다. 덱 장비는 각 영웅을 클릭하여 확인하세요.</p>
        </div>
        <div className="community-actions">
          ...
          <button
            ...
            onClick={() => {
              ...
              window.location.href = '/guild/guild-war/write'
            }}
          >
