...
import { fetchTipPost, updateTipPost } from '../api/endpoints/tip'
    ...
    <section className="community-write">
      <div className="community-toolbar">
        <div className="community-title">
          <h1>글 수정</h1>
          <p>작성한 내용을 업데이트해주세요.</p>
        </div>
        <div className="community-actions">
          <Link className="community-icon-button" to={`/info/${id}`} aria-label="상세로">
      ...
      <div className="community-write-card">
        <form className="community-form" onSubmit={handleSubmit}>
          ...
          <div className="community-form-actions">
            ...
            <Link className="community-cancel" to={`/info/${id}`}>
              취소
            </Link>
          </div>
        </form>
